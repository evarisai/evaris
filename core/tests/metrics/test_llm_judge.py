"""Tests for LLM judge metric (legacy implementation).

These tests validate the legacy LLMJudgeMetric that supports direct
OpenAI, Anthropic, Qwen, and Gemini providers.
"""
...
# Import legacy classes explicitly for testing backward compatibility
...
class TestLLMJudgeMetric:
    ...
    @patch("evaris.metrics.llm_judge_legacy.OPENAI_AVAILABLE", True)
    @patch("evaris.metrics.llm_judge_legacy.openai")
    ...
    @patch("evaris.metrics.llm_judge_legacy.ANTHROPIC_AVAILABLE", True)
    @patch("evaris.metrics.llm_judge_legacy.anthropic")
    ...
    @patch("evaris.metrics.llm_judge_legacy.OPENAI_AVAILABLE", False)
    ...
    @patch("evaris.metrics.llm_judge_legacy.ANTHROPIC_AVAILABLE", False)
    ...
    @patch("evaris.metrics.llm_judge_legacy.LLMJudgeMetric._call_llm")
    @patch("evaris.metrics.llm_judge_legacy.OPENAI_AVAILABLE", True)
    @patch("evaris.metrics.llm_judge_legacy.openai")
