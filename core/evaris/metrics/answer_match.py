...
class AnswerMatchConfig(BaseModel):
    ...
    custom_parser: Callable[[str], Any] | None = Field(
...
class AnswerMatchMetric(BaseMetric):
    ...
    def __init__(self, config: AnswerMatchConfig | None = None):
    ...
    def _extract_json_answer(self, output: str) -> Any | None:
    ...
    def _extract_xml_answer(self, output: str) -> str | None:
    ...
    def _extract_regex_answer(self, output: str) -> str | None:
    ...
    def _extract_delimited_answer(self, output: str) -> str | None:
    ...
    def _extract_answer(self, output: str) -> Any | None:
