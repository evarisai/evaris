...
class LLMJudgeConfig(BaseModel):
    ...
    api_key: str | None = Field(default=None, description="API key (or use env var)")
    ...
    custom_prompt: str | None = Field(default=None, description="Custom judge prompt template")
