...
def register_metric(
    name: str | None | type[BaseMetric] = None,
    overwrite: bool = False,
) -> type[BaseMetric] | Callable[[type[BaseMetric]], type[BaseMetric]]:
...
def register_tool(
    name: str | None | type[BaseTool] = None,
    overwrite: bool = False,
...
def resolve_metric(metric: str | BaseMetric | type[BaseMetric]) -> BaseMetric:
...
def resolve_tool(tool: str | BaseTool | type[BaseTool]) -> BaseTool:
