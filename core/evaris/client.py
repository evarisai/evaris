...
class AssessmentResult:
    ...
    def __init__(
        ...
        name: str,
        status: str,
        summary: AssessmentSummary | None,
    ...
    def from_dict(cls, data: dict[str, Any]) -> AssessmentResult:
        ...
        return cls(
            ...
            summary=summary,
            results=(
                [TestResult.from_dict(r) for r in data["results"]] if data.get("results") else None
            ),
...
class EvarisClient:
    ...
    def __init__(
        ...
        if httpx is None:
            raise ImportError(
                "httpx is required for EvarisClient. " "Install it with: pip install httpx"
            )
