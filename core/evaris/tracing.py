...
class EvarisTracer:
    ...
    def set_reasoning(self, explanation: str, confidence: float | None = None) -> None:
    ...
    def set_cached(self, cached: bool, cache_key: str | None = None) -> None:
...
class DebugLogger:
    ...
    def __init__(self, enabled: bool | None = None, logger_name: str = "evaris.debug"):
...
_global_tracer: EvarisTracer | None = None
...
def configure_debug_logging(enabled: bool | None = None) -> DebugLogger:
    """
