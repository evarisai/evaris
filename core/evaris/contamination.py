...
class DatasetFingerprint(BaseModel):
    ...
    public_url: str | None = Field(default=None, description="URL if publicly available")
...
class ContaminationCheckResult(BaseModel):
    ...
    contamination_type: str | None = Field(
...
class ContaminationDetector:
    ...
    def __init__(self, config: ContaminationConfig | None = None):
    ...
    def comprehensive_check(
        ...
        test_cases: list[TestCase],
        version: str,
        agent_training_cutoff: str | None = None,
