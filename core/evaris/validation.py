...
class ValidationIssue(BaseModel):
    ...
    test_case_index: int | None = Field(default=None, description="Index of affected test case")
    field: str | None = Field(default=None, description="Affected field")
    suggestion: str | None = Field(default=None, description="Suggestion to fix the issue")
...
class TestCaseValidator:
    ...
    def validate_test_case(self, test_case: TestCase, index: int | None = None) -> ValidationResult:
