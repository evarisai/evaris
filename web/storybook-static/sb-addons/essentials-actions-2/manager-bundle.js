try {
	;(() => {
		...
		function Fe(e, t, r) {
			for (r of e.keys()) if (x(r, t)) return r
		}
		function x(e, t) {
			var r, n, a
			if (e === t) return !0
			if (e && t && (r = e.constructor) === t.constructor) {
				...
				if (r === Array) {
					if ((n = e.length) === t.length) for (; n-- && x(e[n], t[n]); );
					return n === -1
				}
				if (r === Set) {
				...
				if (r === Map) {
					...
					for (n of e)
						if (
							((a = n[0]),
							(a && typeof a == "object" && ((a = Fe(t, a)), !a)) || !x(n[1], t.get(a)))
						)
							return !1
					return !0
				}
				...
				if (!r || typeof e == "object") {
					n = 0
					for (r in e)
						if ((Be.call(e, r) && ++n && !Be.call(t, r)) || !(r in t) || !x(e[r], t[r])) return !1
		...
		var vt = (t) => t.length === 7 && t[1] === t[2] && t[3] === t[4] && t[5] === t[6]
					? "#" + t[1] + t[3] + t[5]
					: t,
			ae = vt
		function N(e) {
			...
			Qt = (e, t, r, n) => {
				if ((t && typeof t == "object") || typeof t == "function")
					for (const a of tt(t))
						!qt.call(e, a) &&
							a !== r &&
							pe(e, a, { get: () => t[a], enumerable: !(n = Xt(t, a)) || n.enumerable })
				return e
			},
			er = (e, t, r) => (
				(r = e != null ? Jt(Zt(e)) : {}),
					...
					i.forEach((l) => {
						const u = l.split("."),
							c = (p, d, f) => {
								...
								const E = u[f]
								if (f === 0) J(p, t) && (E === Z || E === Ze) && c(p, Z, f + 1)
								else if (E === Ze)
		...
		var ce = ({ data: e }) => {
				...
				if (Array.isArray(r)) {
					...
					return o.createElement(
						...
						o.createElement("span", { style: t.preview }, "[", qe(a, ", "), "]")
					)
				} else {
		...
		var Er = ({ rows: e, columns: t, rowsData: r }) => {
			...
			lt = Se(({ children: e, className: t }, r) =>
				o.createElement(xe, { ref: r, horizontal: !0, vertical: !0, className: t }, e)
			)
			...
			return (
				...
				o.createElement(
					...
					o.createElement(
						...
						e === 0 ? "" : o.createElement(Ie, { status: "neutral" }, e)
					)
				)
			)
		}
		Q.register(z, (e) => {
			Q.add($t, {
				title: jr,
				type: De.PANEL,
				render: ({ active: t }) => o.createElement(Hr, { api: e, active: !!t }),
				paramKey: Yt,
			})
		})
	})()
