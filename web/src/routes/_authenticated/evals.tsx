...
function Evals() {
	...
	// Fetch projects for the run dialog
	const { data: projects } = trpc.projects.list.useQuery()

	// Fetch datasets for the run dialog (filtered by selected project)
	...
	// Transform evals data for the table
	const tableData =
						...
						<div className="space-y-2">
							...
							<Select
								...
								onValueChange={(value) => {
									...
									setSelectedDataset("") // Reset dataset when project changes
								}}
							>
